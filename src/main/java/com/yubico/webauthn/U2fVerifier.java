...
public class U2fVerifier {
    ...
    public static boolean verify(AppId appId, RegistrationRequest request, U2fRegistrationRequest response) throws CertificateException, IOException, Base64UrlException {
